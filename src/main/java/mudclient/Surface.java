...
public class Surface {
    ...
    public Surface(int width, int height, int limit, mudclient component) {
        ...
        rgbPixels = Uint8ClampedArray.create(width * height * 4);
    ...
    public void draw(int x, int y) {
        ...
        this.component.imageData.setData(this.rgbPixels);
        this.component.context.putImageData(this.component.imageData, 0, 0);
    }
    ...
    private void drawSprite(int dest[], int src[], int i, int srcPos, int destPos, int width, int height, int j1, int k1, int yInc) {
        int i2 = -(width >> 2);
        width = -(width & 3);
    ...
    private void drawSprite(int target[], byte colourIdx[], int colours[], int srcPos, int destPos, int width, int height, int w2, int h2, int rowInc) {
        int l1 = -(width >> 2);
        width = -(width & 3);
    ...
    private void plotScale(int dest[], int src[], int i, int j, int k, int destPos, int i1, int j1, int k1, int l1, int i2, int j2, int k2) {
        int l2 = j;
    ...
    private void drawSpriteAlpha(int dest[], int src[], int i, int srcPos, int size, int width, int height, int extraXSpace, int k1, int yInc, int alpha) {
        int j2 = 256 - alpha;
    ...
    private void drawSpriteAlpha(int dest[], byte coloursUsed[], int colourList[], int listPos, int size, int width, int height, int extraXSpace, int j1, int yInc, int alpha) {
        int i2 = 256 - alpha;
        for (int j2 = -height; j2 < 0; j2 += yInc) {
            for (int k2 = -width; k2 < 0; k2++) {
    ...
    private void transparentScale(int dest[], int src[], int i, int j, int k, int destPos, int i1, int j1, int k1, int l1, int i2, int j2, int yInc, int alpha) {
        int i3 = 256 - alpha;
        int j3 = j;
    ...
    private void plotScale(int target[], int pixels[], int i, int j, int k, int l, int i1, int width, int height, int l1, int i2, int j2, int yInc, int colour) {
    ...
    public void drawMinimapSprite(int x, int y, int sprite, int rotation, int scale) {
        int j1 = width2;
        int k1 = height2;
    ...
    private void drawMinimap(int ai[], int ai1[], int i, int j, int k, int l, int i1, int j1, int k1, int l1) {
        for (i = k1; i < 0; i++) {
    ...
    private void drawMinimapTranslate(int ai[], int ai1[], int i, int j, int k, int l, int i1, int j1, int k1, int l1) {
    ...
    public void spriteClipping(int x, int y, int w, int h, int sprite, int colour1, int colour2, int l1, boolean flag) {
        if (colour1 == 0)
            colour1 = 0xffffff;
        if (colour2 == 0)
            colour2 = 0xffffff;
    ...
    private void transparentSpritePlot(int dest[], int src[], int i, int j, int k, int destPos, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3) {
        int i4 = j2 >> 16 & 0xff;
        int j4 = j2 >> 8 & 0xff;
        int k4 = j2 & 0xff;
        int l4 = j;
    ...
    private void transparentSpritePlot(int dest[], int src[], int i, int j, int k, int destPos, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3, int j3) {
        int j4 = j2 >> 16 & 0xff;
        int k4 = j2 >> 8 & 0xff;
        int l4 = j2 & 0xff;
        int i5 = k2 >> 16 & 0xff;
    ...
    private void transparentSpritePlot(int dest[], byte colourIdx[], int colours[], int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3) {
        int i4 = j2 >> 16 & 0xff;
        int j4 = j2 >> 8 & 0xff;
        int k4 = j2 & 0xff;
        int l4 = j;
    ...
    private void transparentSpritePlot(int dest[], byte coloursUsed[], int colourList[], int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3, int j3) {
        int j4 = j2 >> 16 & 0xff;
        int k4 = j2 >> 8 & 0xff;
        int l4 = j2 & 0xff;
        int i5 = k2 >> 16 & 0xff;
    ...
    private void method259(int ai[], byte abyte0[], int i, int j, int k, int l, int i1, int j1, int k1) {// todo
